...
<body>
    ...
    <main class="main-content">
        ...
        <!-- Recent Pending Peminjaman -->
        <div class="row mt-4">
            <div class="col-12">
                <div class="activity-card">
                    <div class="card-header-custom">
                        <h5 class="mb-0">Peminjaman Menunggu Persetujuan</h5>
                        <a href="peminjaman.php" class="btn-custom btn-info-custom">
                    ...
                    <?php else: ?>
                        <p class="text-muted text-center py-4">Tidak ada peminjaman yang menunggu persetujuan.</p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
