    ...
    <main class="main-content">
        ...
        <div class="table-card">
            <div class="card-header-custom">
                ...
                <a href="alat_tambah.php" class="btn-add">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="alat_edit.php?id=<?php echo $alat['id']; ?>" class="btn-action btn-edit">
                                        <i data-lucide="edit-2"></i>
                                    </a>
                                    <a href="alat.php?delete=<?php echo $alat['id']; ?>" class="btn-action btn-delete" onclick="return confirm('Apakah Anda yakin ingin menghapus alat ini?')">
